...
# Pregunta 2.a ------------------------------------------------------------
 ...
 # Importa las secuencias contenidas en el archivo bicho.fasta, guardándolas como un objeto en R. Describe y fundamenta cada paso. (3 puntos)
...
#	¿Qué tipo de objeto se creó en el punto anterior? ¿Cómo lo averiguaste? (2 puntos)
...
# ¿Cuántas secuencias contiene el objeto? Describe los comandos utilizados. (3 puntos)
